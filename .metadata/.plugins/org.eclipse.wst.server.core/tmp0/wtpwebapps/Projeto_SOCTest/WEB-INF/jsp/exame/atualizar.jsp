	...
	<div class="container custon-transley">
		<div class="row justify-content-center pb-5">
	  	...
	  	<div class="row justify-content-center">
		    ...
		    <h4 class="pt-3">Exame código ${exame.id}</h4>
				<form action="atualizarExame"method="post">
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
						...
						<input class="form-control" value="${exame.id_pcnt}" type="number" required="required" placeholder="Código do paciente" name="exame.id_pcnt">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Relatório do Exame</label>
